...
private:
	...
	/* 父类的DocumentManager 判断Factor时,EventGraph 父类都属于 FDocumentTabFactoryForObjects<UDialogueBuilderEdGraph> 所以要新建一个新的DocumentManager */
	TSharedPtr<FDocumentTracker> DialogueDocumentManager;
